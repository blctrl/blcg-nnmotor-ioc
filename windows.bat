...
set PATH=E:\epics\bin;%PATH%
set PATH=E:\epics\base-3.16.2\bin\windows-x64;%PATH%
rem The location of Microsoft Visual Studio (pathname).
set _visual_studio_home=C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build
...
set _epics_base=E:\epics\base-3.16.2
...
call "%_visual_studio_home%\vcvarsall.bat" x64
...
rem set _auto=
rem set _auto_path_reset=
rem set _auto_path_append=
rem set _path_new=
rem set _strawberry_perl_home=
rem set _visual_studio_home=
rem set _epics_host_arch=
rem set _epics_base=
cmd